...
-------------------------------------------------------------------------------------------------
Be sure to have a good understanding of our Code of Conduct policy, which can be found here: [http://www.pytexas.org/2013/about/conduct/](http://www.pytexas.org/2013/about/conduct/)
...
Prepare an initial response to the incident. This initial response is very important and will set the tone for PyTexas. Depending on the severity/details of the incident, please follow these guidelines:
...
A listing of [PyTexas staff is located here](/2013/about/staff/), including contact phone numbers. If at all possible, all reports should be made directly to [Ewa Jodlowska](mailto:ewa@python.org) (Event Coordinator) or [Jesse Noller](mailto:jnoller@python.org) (PyTexas Chair).
